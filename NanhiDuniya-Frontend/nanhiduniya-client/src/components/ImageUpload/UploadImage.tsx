...
const UploadImage = () => {
  ...
  const onSubmit = async (data: FieldValues) => {
    try {
      ...
      const result = await uploadeImage(formData);
  ...
  const handleDelete = () => {
    setValue('file', null); // Clear file input
      ...
      <div className="col-span-5 xl:col-span-2">
        <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="p-7">
            ...
            <div
              id="FileUpload"
              className="relative mb-5.5 block w-full rounded border border-dashed border-primary bg-gray-200 dark:bg-gray-700 animate-pulse"
            >
              <div className="flex flex-col items-center justify-center space-y-3 p-7">
                <div className="h-10 w-10 rounded-full border border-stroke bg-gray-300 dark:border-strokedark dark:bg-boxdark"></div>
