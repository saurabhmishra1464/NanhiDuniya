...
if(isLoading){
  return (
    ...
    <div className="flex flex-col">
      ...
      <div className="h-3 w-24 mt-2 bg-gray-200 dark:bg-gray-700 animate-pulse"></div>
    </div>
  </div>
  )
}
    ...
    <ClickOutside onClick={() => setDropdownOpen(false)} className="relative">
      ...
      {dropdownOpen && (
        ...
        >
          ...
          <button onClick={()=>openModal(ModalTypes.LOGOUT)} className="flex items-center gap-3.5 px-6 py-4 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base">
            <svg
              className="fill-current"
              width="22"
              height="22"
