        ...
        <div className="hidden w-full xl:block xl:w-1/2">
          <div className="px-26 py-17.5 text-center">
            <Link className="mb-5.5 inline-block" href="/">
              ...
              <h3 className="text-3xl font-bold text-black dark:text-white">NanhiDuniya</h3>
            </Link>
              ...
              <div className="mb-4">
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white ${errors.userName ? 'border-red-500' : 'dark:focus:border-primary'}`}
                  />
